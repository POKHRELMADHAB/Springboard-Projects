...
# ##### import pandas as pd
# properties =pd.read_excel(https://data.london.gov.uk/download/uk-house-price-index/70ac0766-8902-4eb5-aab5-01951aaed773/UK%20House%20price%20index.xls, sheet_name='Average price', index_col= None)
# properties.head()
...
melt_properties = pd.melt(properties, id_vars=['London_Borough', 'ID'])
...
# In the order, Hackney shows almost 620% increase in 2018 compared to that 1998 where other follows and I have plotted Top ten London_Borough based on the average proce increased. To find in %, ratios is multplied with 100% 
